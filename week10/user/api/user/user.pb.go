...
type UserListRequest struct {
	...
	UserIds []uint64 `protobuf:"varint,5,rep,packed,name=userIds,proto3" json:"userIds,omitempty"`
}
...
func (x *UserListRequest) GetUserIds() []uint64 {
	if x != nil {
		return x.UserIds
	}
	return nil
...
type UserListReply struct {
	...
	List []*UserStruct `protobuf:"bytes,3,rep,name=list,proto3" json:"list,omitempty"`
}
...
func (x *UserListReply) GetCode() uint32 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *UserListReply) GetMsg() string {
	if x != nil {
		return x.Msg
	}
	return ""
...
func (x *UserListReply) GetList() []*UserStruct {
	if x != nil {
		return x.List
	}
	return nil
...
var file_api_user_user_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x08, 0x61, 0x70, 0x69, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x1a,
	...
	0x04, 0x52, 0x07, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x73, 0x22, 0x68, 0x0a, 0x0a, 0x75, 0x73,
	0x65, 0x72, 0x53, 0x74, 0x72, 0x75, 0x63, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x75, 0x69, 0x64, 0x18,
	...
	0x61, 0x74, 0x61, 0x72, 0x22, 0x5f, 0x0a, 0x0d, 0x55, 0x73, 0x65, 0x72, 0x4c, 0x69, 0x73, 0x74,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6d, 0x73, 0x67, 0x12, 0x28, 0x0a, 0x04, 0x6c,
	0x69, 0x73, 0x74, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x61, 0x70, 0x69, 0x2e,
	0x55, 0x73, 0x65, 0x72, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x53, 0x74, 0x72, 0x75, 0x63, 0x74, 0x52,
	0x04, 0x6c, 0x69, 0x73, 0x74, 0x32, 0x5a, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x52, 0x0a,
	0x08, 0x55, 0x73, 0x65, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x19, 0x2e, 0x61, 0x70, 0x69, 0x2e,
	0x55, 0x73, 0x65, 0x72, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x17, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x2e,
	...
	0x74, 0x42, 0x26, 0x0a, 0x08, 0x61, 0x70, 0x69, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x50, 0x01, 0x5a,
	0x18, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x77, 0x6f, 0x72, 0x6c, 0x64, 0x2f, 0x61, 0x70, 0x69, 0x2f,
	0x55, 0x73, 0x65, 0x72, 0x3b, 0x55, 0x73, 0x65, 0x72, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
var file_api_user_user_proto_goTypes = []interface{}{
	(*UserListRequest)(nil), // 0: api.User.UserListRequest
	(*UserStruct)(nil),      // 1: api.User.userStruct
	(*UserListReply)(nil),   // 2: api.User.UserListReply
}
var file_api_user_user_proto_depIdxs = []int32{
	1, // 0: api.User.UserListReply.list:type_name -> api.User.userStruct
	0, // 1: api.User.User.UserList:input_type -> api.User.UserListRequest
	2, // 2: api.User.User.UserList:output_type -> api.User.UserListReply
