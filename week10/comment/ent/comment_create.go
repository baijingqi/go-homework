...
func (cc *CommentCreate) SetUID(u uint64) *CommentCreate {
	cc.mutation.SetUID(u)
	return cc
}

// SetRelationID sets the "relation_id" field.
func (cc *CommentCreate) SetRelationID(u uint64) *CommentCreate {
	cc.mutation.SetRelationID(u)
	return cc
}

// SetReplyToUID sets the "reply_to_uid" field.
func (cc *CommentCreate) SetReplyToUID(u uint64) *CommentCreate {
	cc.mutation.SetReplyToUID(u)
	return cc
}

// SetNillableReplyToUID sets the "reply_to_uid" field if the given value is not nil.
func (cc *CommentCreate) SetNillableReplyToUID(u *uint64) *CommentCreate {
	if u != nil {
		cc.SetReplyToUID(*u)
	}
	return cc
...
func (cc *CommentCreate) SetRelationType(u uint32) *CommentCreate {
	cc.mutation.SetRelationType(u)
	return cc
}

// SetParentID sets the "parent_id" field.
func (cc *CommentCreate) SetParentID(u uint64) *CommentCreate {
	cc.mutation.SetParentID(u)
	return cc
}

// SetNillableParentID sets the "parent_id" field if the given value is not nil.
func (cc *CommentCreate) SetNillableParentID(u *uint64) *CommentCreate {
	if u != nil {
		cc.SetParentID(*u)
	}
	return cc
...
func (cc *CommentCreate) SetBelongCommentID(u uint64) *CommentCreate {
	cc.mutation.SetBelongCommentID(u)
	return cc
}

// SetNillableBelongCommentID sets the "belong_comment_id" field if the given value is not nil.
func (cc *CommentCreate) SetNillableBelongCommentID(u *uint64) *CommentCreate {
	if u != nil {
		cc.SetBelongCommentID(*u)
	}
	return cc
}
...
func (cc *CommentCreate) defaults() {
	if _, ok := cc.mutation.ReplyToUID(); !ok {
		v := comment.DefaultReplyToUID
		cc.mutation.SetReplyToUID(v)
	}
	if _, ok := cc.mutation.ParentID(); !ok {
		v := comment.DefaultParentID
		cc.mutation.SetParentID(v)
	}
	if _, ok := cc.mutation.BelongCommentID(); !ok {
		v := comment.DefaultBelongCommentID
		cc.mutation.SetBelongCommentID(v)
	}
...
func (cc *CommentCreate) check() error {
	...
	if _, ok := cc.mutation.RelationID(); !ok {
		return &ValidationError{Name: "relation_id", err: errors.New(`ent: missing required field "relation_id"`)}
	}
	if v, ok := cc.mutation.RelationID(); ok {
	...
	if _, ok := cc.mutation.ReplyToUID(); !ok {
		return &ValidationError{Name: "reply_to_uid", err: errors.New(`ent: missing required field "reply_to_uid"`)}
	}
	if _, ok := cc.mutation.RelationType(); !ok {
		return &ValidationError{Name: "relation_type", err: errors.New(`ent: missing required field "relation_type"`)}
	}
	if v, ok := cc.mutation.RelationType(); ok {
	...
	if _, ok := cc.mutation.BelongCommentID(); !ok {
		return &ValidationError{Name: "belong_comment_id", err: errors.New(`ent: missing required field "belong_comment_id"`)}
	}
	if _, ok := cc.mutation.Content(); !ok {
...
func (cc *CommentCreate) createSpec() (*Comment, *sqlgraph.CreateSpec) {
	...
	if value, ok := cc.mutation.RelationID(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeUint64,
			Value:  value,
	...
	if value, ok := cc.mutation.ReplyToUID(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeUint64,
			Value:  value,
			Column: comment.FieldReplyToUID,
		})
		_node.ReplyToUID = value
	}
	if value, ok := cc.mutation.RelationType(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
	...
	if value, ok := cc.mutation.BelongCommentID(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeUint64,
			Value:  value,
			Column: comment.FieldBelongCommentID,
		})
		_node.BelongCommentID = value
	}
